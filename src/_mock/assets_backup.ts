...
export const DB_MENU: Menu[] = [
	...
	// cash balance
	{
		id: "management_cash_balance",
		parentId: "management",
		name: "cashBalance.title",
		code: "management:cash_balance",
		icon: "solar:wallet-money-bold-duotone",
		type: MENU,
		path: "/management/cash-balance",
		component: "/features/cash_balance/presentation/pages/CashBalancePage",
	},
	// menulevel
	{
		id: "menulevel",
...
export const DB_ROLE: Role[] = [
	{ id: "role_admin_id", name: "reyes160@gmail.com", code: "SUPER_ADMIN" },
...
export const DB_ROLE_PERMISSION = [
	{ id: faker.datatype.uuid(), roleId: "role_admin_id", permissionId: "permission_create" },
	{ id: faker.datatype.uuid(), roleId: "role_admin_id", permissionId: "permission_read" },
	{ id: faker.datatype.uuid(), roleId: "role_admin_id", permissionId: "permission_update" },
	{ id: faker.datatype.uuid(), roleId: "role_admin_id", permissionId: "permission_delete" },

	{ id: faker.datatype.uuid(), roleId: "role_test_id", permissionId: "permission_read" },
	{ id: faker.datatype.uuid(), roleId: "role_test_id", permissionId: "permission_update" },
] as const;
