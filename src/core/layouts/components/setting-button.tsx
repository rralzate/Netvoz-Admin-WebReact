...
import { type SettingsType, useSettingActions, useSettings } from "@/core/store/settingStore";
import { themeVars } from "@/core/theme/theme.css";
import { presetsColors } from "@/core/theme/tokens/color";
import { FontFamilyPreset } from "@/core/theme/tokens/typography";
import { type ThemeColorPresets, ThemeLayout, ThemeMode } from "@/core/types/enum";
...
export default function SettingButton() {
	...
	const sheetContentBgStyle: CSSProperties = {
		...
		background: "linear-gradient(135deg, rgba(0,200,255,0.1) 0%, transparent 50%), linear-gradient(315deg, rgba(255,100,100,0.1) 0%, transparent 50%)",
	};
