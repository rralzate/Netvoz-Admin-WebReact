...
export default function Page403() {
	...
	const svg = (
		<svg viewBox="0 0 480 360" xmlns="http://www.w3.org/2000/svg" width={400} height={400} className="w-full">
			...
			<path
				...
				opacity="0.2"
			/>
			<circle cx="295" cy="150" r="60" fill={themeVars.colors.palette.primary.default} opacity="0.3" />
			<path
	...
	return (
		<ErrorLayout
			title={t("sys.nav.error.page403.title")}
			helmetTitle="403 Access Denied!"
			desc={t("sys.nav.error.page403.description")}
