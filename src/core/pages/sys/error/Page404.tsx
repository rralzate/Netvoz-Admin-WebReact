...
export default function Page404() {
	...
	const svg = (
		<svg viewBox="0 0 480 360" xmlns="http://www.w3.org/2000/svg" width={400} height={400} className="w-full">
			...
			<circle cx="280" cy="150" r="60" fill={themeVars.colors.palette.primary.default} opacity="0.3" />
			{/* sun */}
	...
	return (
		<ErrorLayout
			title={t("sys.nav.error.page404.title")}
			helmetTitle="404 Page Not Found!"
			desc={t("sys.nav.error.page404.description")}
			buttonText={t("sys.nav.error.goToHome")}
			svg={svg}
		/>
	);
}
